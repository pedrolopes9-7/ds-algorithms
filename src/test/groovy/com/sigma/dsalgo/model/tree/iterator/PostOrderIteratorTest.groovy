...
class PostOrderIteratorTest extends Specification {

    def "constructor - happy path adds the elements post order traversal"() {
        given:
        ...
        when:
        def iterator = new PostOrderIterator(tree)

        then:
        iterator.postOrderList == [4, 2, 20, 10, 50]
    }
